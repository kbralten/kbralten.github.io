...
-   [gerber_tool](https://github.com/kbralten/gerber_tool): A modern, browser-based Gerber file viewer and converter. Features a drag-and-drop interface for `.gbr`, `.drl`, and `.zip` archives, smart layer management with automatic color assignment, and an interactive canvas. Supports exporting boards to clean, consolidated SVGs with merged polygons. Try the [interactive web tool](https://kbralten.github.io/gerber_tool/). (AGPL-3.0)
